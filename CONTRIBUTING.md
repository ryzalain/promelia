# Contributing to Promelia

Thank you for your interest in contributing to Promelia. This guide covers everything you need to get started.
...
```bash
git clone https://github.com/ryzalain/Promelia.git
cd Promelia
pip install -e ".[dev]"
playwright install chromium
```

This installs Promelia in editable mode with all development dependencies (pytest, ruff, etc.) and downloads the Chromium browser binary for Playwright.
...
4. Test discovery: `promelia discover --employer "Company Name"`
...
3. Test: `promelia discover --site "Company Name"`
4. Submit a PR

### Bug Fixes and Features

1. Check existing [issues](https://github.com/ryzalain/Promelia/issues) to avoid duplicating work
...
# Run with coverage
pytest tests/ --cov=src/promelia --cov-report=term-missing
```

## Linting and Code Style

Promelia uses [Ruff](https://docs.astral.sh/ruff/) for linting and formatting.
...
By contributing to Promelia, you agree that your contributions will be licensed under the [GNU Affero General Public License v3.0](LICENSE).
