...
from promelia.config import COVER_LETTER_DIR, RESUME_PATH, load_profile
from promelia.database import get_connection, get_jobs_by_stage
from promelia.llm import get_client
from promelia.scoring.validator import (
    BANNED_WORDS,
    LLM_LEAK_PHRASES,
    sanitize_text,
...
def run_cover_letters(min_score: int = 7, limit: int = 20,
    ...
    for job in jobs:
        ...
        try:
            ...
            pdf_path = None
            try:
                from promelia.scoring.pdf import convert_to_pdf
