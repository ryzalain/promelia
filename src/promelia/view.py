"""Promelia HTML Dashboard Generator.
...
from promelia.config import APP_DIR, DB_PATH
...
def generate_dashboard(output_path: str | None = None) -> str:
    ...
    Args:
        output_path: Where to write the HTML file. Defaults to ~/.promelia/dashboard.html.
...
<title>Promelia Dashboard</title>
<style>
