...
from promelia.apply import chrome, dashboard, prompt as prompt_mod
from promelia.apply.chrome import (
    launch_chrome, cleanup_worker, kill_all_chrome,
    reset_worker_dir, cleanup_on_exit, _kill_process_tree,
    BASE_CDP_PORT,
)
from promelia.apply.dashboard import (
...
def _load_blocked():
    from promelia.config import load_blocked_sites
...
def acquire_job(target_url: str | None = None, min_score: int = 7,
    ...
    try:
        ...
        from promelia.config import is_manual_ats
